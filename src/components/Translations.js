export const t = {
  ko: {
    subtitle: "베트남 행정 및 법률 상황 분석 지원",
    logout: "로그아웃", login: "로그인", signup: "회원가입", mypage: "마이페이지",
    emptyHistory: "아직 분석 내역이 없습니다.",
    roleUser: "질문", roleAI: "AI 분석", roleDoc: "베트남어 서류 초안",
    downloadWord: "📘 워드 다운로드", downloadExcel: "📗 엑셀 다운로드", copy: "📋 복사",
  ...
  en: {
    ...
    logout: "Logout", login: "Login", signup: "Sign up", mypage: "My Page",
    emptyHistory: "No analysis history yet.",
    roleUser: "Question", roleAI: "AI Analysis", roleDoc: "Document Draft",
    downloadWord: "📘 Word", downloadExcel: "📗 Excel", copy: "📋 Copy",
    makeDoc: "🇻🇳 Generate Doc", placeholder: "Please enter details...",
